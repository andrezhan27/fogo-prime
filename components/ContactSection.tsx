      ...
      <div className="mx-auto max-w-[72rem]">
        <Reveal className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="lg:sticky lg:top-32 lg:self-start">
            <h2 className="font-heading text-[clamp(2.7rem,5vw,4.5rem)] leading-none font-semibold tracking-[-0.035em]">{copy.contact.title}</h2>
            <dl className="mt-10 border-t border-[#b9aa94]/70">
              <div className="grid grid-cols-[2.5rem_1fr] gap-x-4 border-b border-[#b9aa94]/70 py-6 sm:grid-cols-[2.5rem_6.5rem_1fr]">
                ...
                <dt className="pt-1 text-xs font-bold uppercase tracking-[0.12em] text-[#7e7161]">{copy.contact.addressLabel}</dt>
              ...
              <div className="grid grid-cols-[2.5rem_1fr] gap-x-4 border-b border-[#b9aa94]/70 py-6 sm:grid-cols-[2.5rem_6.5rem_1fr]">
                ...
                <dt className="pt-1 text-xs font-bold uppercase tracking-[0.12em] text-[#7e7161]">{copy.contact.phoneLabel}</dt>
                <dd className="col-start-2 mt-2 text-base leading-7 sm:col-start-3 sm:mt-0"><a href={restaurantInfo.phoneHref} className="hover:text-[#865d00]">{restaurantInfo.phoneDisplay}</a></dd>
              </div>
              <div className="grid grid-cols-[2.5rem_1fr] gap-x-4 border-b border-[#b9aa94]/70 py-6 sm:grid-cols-[2.5rem_6.5rem_1fr]">
                <Clock3 aria-hidden="true" className="mt-1 size-5 text-[#9b6a00]" strokeWidth={1.7} />
                <dt className="pt-1 text-xs font-bold uppercase tracking-[0.12em] text-[#7e7161]">{copy.contact.hoursLabel}</dt>
                <dd className="col-start-2 mt-2 max-w-sm text-base leading-7 sm:col-start-3 sm:mt-0">{copy.contact.hours}</dd>
              </div>
            </dl>
