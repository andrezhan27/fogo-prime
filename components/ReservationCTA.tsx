...
export function ReservationCTA() {
  ...
  return (
    <section id="reservar" className="bg-[#0b0b0a] px-6 py-12 text-[#f7f0e5] sm:px-10 sm:py-16 lg:px-16 lg:py-20 xl:px-20">
      <Reveal className="mx-auto grid max-w-[76rem] border border-white/13 lg:grid-cols-[1.1fr_.9fr]">
        ...
        <div className="flex flex-col justify-center bg-[#15130f] px-6 py-14 sm:px-12 lg:px-16">
          <h2 className="font-heading text-[clamp(2.7rem,5vw,4.5rem)] leading-none font-semibold tracking-[-0.035em]">{copy.reserve.title}</h2>
